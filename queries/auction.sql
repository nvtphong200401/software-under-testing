...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 15, 2022 at 04:06 AM
...
(1, 6, '2022-01-14 08:56:22', '300000'),
...
(1, 27, '2022-01-14 20:00:34', '10000000'),
(1, 29, '2022-01-14 08:51:54', '1510000'),
...
(2, 29, '2022-01-14 08:51:54', '1520000'),
...
(31, 6, '2022-01-14 08:56:22', '300000'),
...
(2, 37, '2022-01-14 08:55:19', 1, 'Đồ tốt nha bạn', 29),
(34, 2, '2022-01-14 00:35:21', 1, 'Giay tot, se mua tiep', 20),
(37, 2, '2022-01-14 08:55:42', 1, 'Trả tiền đầy đủ', 29);
...
(3, 'Torrini KC241', 15, 30, NULL, 0, '160000000', '100000', '500000000', '2021-12-02 08:41:03', '2022-01-20 07:57:38', 'Nhẫn kim cương - vẻ đẹp kiêu sa', '<P>Không chỉ có kiểu dáng truyền thống chỉ có một hạt kim cương ở giữa, các nhà thiết kế đã tạo những những chiếc nhẫn vô cùng độc đáo và tinh tế. Tuy nhiên, giá của đồ trang sức này thì chỉ có dân chơi mới có thể kham được.</P>\r\n<UL>\r\n    <LI>Kiểu sản phẩm: Nhẫn nữ</LI>\r\n    <LI>Loại đá: To paz</LI>\r\n    <LI>Chất liệu: kim cương, nguyên liệu và công nghệ Italy...</LI>\r\n    <LI>Đơn giá: 2,110,250 VND / Chiếc</LI>\r\n</UL>\r\n', 1, 1),
...
(27, 'Bàn làm việc', 12, 1, 1, 1, '500000', '50000000', '10000000', '2022-01-13 23:21:28', '2022-01-14 20:00:34', 'Bàn gỗ ', '<ul>\r\n<li>Chắc chắn</li>\r\n<li>Nhẹ</li>\r\n<li>Tiện dụng</li>\r\n</ul>', 0, 1),
(28, 'Ghế gỗ', 13, 1, NULL, 0, '100000', '10000', '5000000', '2022-01-13 23:48:29', '2022-01-15 23:47:00', 'Ghế chắc chắn', '<ul>\r\n<li>Ghế gỗ</li>\r\n<li>Thơm</li>\r\n<li>Chắc chắn</li>\r\n</ul>', 1, 1),
(29, 'Laptop pro', 6, 37, 2, 1, '1000000', '10000', '90000000', '2022-01-14 08:48:37', '2022-01-14 08:53:42', 'Laptop xịn', '<ul>\r\n<li>Laptop</li>\r\n<li>&nbsp;</li>\r\n</ul>', 1, 1);
...
('7h_rnCpxmMBM43OdO1EuenKpN7LyYBk2', 1642211725, '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"auth\":true,\"cart\":[],\"flash\":{},\"authUser\":{\"ID\":2,\"Username\":\"ntmthu\",\"FullName\":\"Nguyễn Thị Minh Thu\",\"DOB\":\"2021-12-27T17:00:00.000Z\",\"Email\":\"19127568@student.hcmus.edu.vn\",\"Role\":1,\"Pending\":0,\"Verified\":1,\"isBanned\":0,\"ExpiredDate\":null},\"retUrl\":\"/bidder/product/list/won\"}'),
('iZCdLhmGuR2jdcPySCoN0ZKchJa-WOmD', 1642251664, '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"auth\":true,\"cart\":[],\"flash\":{},\"authUser\":{\"ID\":1,\"Username\":\"admin\",\"FullName\":\"Nguyễn Văn Tấn Phong\",\"DOB\":\"2001-04-18T17:00:00.000Z\",\"Email\":\"nvtphong19@clc.fitus.edu.vn\",\"Role\":2,\"Pending\":0,\"Verified\":1,\"isBanned\":0,\"ExpiredDate\":null},\"retUrl\":\"/bidder/product/list/active\"}'),
('tdtydW2nkqjS3eeKRsXJXBtbFkG0Tkpi', 1642212143, '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"auth\":false,\"cart\":[],\"flash\":{},\"authUser\":null,\"retUrl\":\"/bidder/profile\",\"passport\":{\"user\":{\"id\":\"2946274515703275\",\"name\":{\"familyName\":\"Nguyễn\",\"givenName\":\"Phong\",\"middleName\":\"Văn Tấn\"},\"emails\":[{\"value\":\"hackkerguy@yahoo.com\"}],\"provider\":\"facebook\",\"_raw\":\"{\\\"id\\\":\\\"2946274515703275\\\",\\\"email\\\":\\\"hackkerguy\\\\u0040yahoo.com\\\",\\\"last_name\\\":\\\"Nguy\\\\u1ec5n\\\",\\\"first_name\\\":\\\"Phong\\\",\\\"middle_name\\\":\\\"V\\\\u0103n T\\\\u1ea5n\\\",\\\"birthday\\\":\\\"04\\\\/20\\\\/2001\\\"}\",\"_json\":{\"id\":\"2946274515703275\",\"email\":\"hackkerguy@yahoo.com\",\"last_name\":\"Nguyễn\",\"first_name\":\"Phong\",\"middle_name\":\"Văn Tấn\",\"birthday\":\"04/20/2001\"}}}}');
...
(35, 'phong12345', 'Nguyễn Văn Tấn Phong', '$2a$10$rgAykWs9sX.phaJUm.wT2.PVz1tQeWQzjjY0Wnw0zbfzADU7t9LI.', '2000-01-08', 'nvtphong.19@gmail.com', 0, 0, 0, 0, NULL),
(36, 'ntmthu123', 'Nguyễn Văn Tấn Phong', '$2a$10$/CBP/ogNmOwlqPyLLdB8UOeGxfgbVYKVpnrnTRFNm2dtiVyNL7Jxa', '2000-01-08', 'nvtphong.19@clc.fitus.edu.vn', 0, 0, 0, 0, NULL),
(37, 'hieu123', 'Trần Trung Hiếu', '$2a$10$UNKRCE/n1xLtI3nuZA2paeF3UUz/DGH9l6megfBdGCXsCIuSCOJK2', '2000-01-08', 'dragonslayers.248@gmail.com', 1, 0, 1, 0, '2022-01-21');
...
(11, 'nvtphong.19@gmail.com', 'kCTPeO6IWEWyPGa15pgv', '2022-01-14'),
(12, 'nvtphong.19@clc.fitus.edu.vn', 'LYFjJLHtJ9hZoxUNQMcX', '2022-01-14');
